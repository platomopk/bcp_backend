<br>
<div id="tab1" class="tab-pane fade in active" style="height:1920px;background-color: #EEEEEE; padding:20px;">
    ...
    <div>
        <form action="createnewcampaign.php" id="createNewCampaignForm" method="get" accept-charset="utf-8">
            ...
            <div class="row">
                <input class="btn btn-default" type="submit" name="submit" value="Send Notification" style="margin-left: 15px; background-color: #333;color:#fff">
            </div>
        </form> 
    </div>
    <br>
