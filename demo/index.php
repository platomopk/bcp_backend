                    ...
                    <div class="row" id="loginWrapper">
                        <div class="container" id="loginContainer">
                            <div class="row" id="loginBox">
                                <!-- login container -->
                                <div style="opacity:0.9;width: 350px;height: auto;margin:0px auto;border-radius: 10px;border-color: #333; background-color:#424242;  border-width: 2px; border-style: solid;">
                                <!-- sms -->
                                <div style="padding:15px; padding-bottom:0px; color:#fff; text-align: center;">
                                    <label style="font-weight: 100;font-size: 18px;    text-shadow: 0px 0px 6px #e6e6e6;">BAHRIA COMPOSITE PROJECT</label>
                                </div>
                                <!-- email -->
                                ...
                                <!-- submit -->
                                <div style="padding:0px 15px 15px 15px">
                                    <input type="submit" name="submit" value="Log In" class="btn btn-success" style="background-color:#3A7058; border-color:#fff; width: 100%">
                                </div>
                                <!-- forgot -->
