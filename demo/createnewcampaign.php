...
include 'db_connect.php';
    ...
    "select notificationId, (select users.usertoken from users where userId = notifications.userId) as token from notifications where notifications.campaignId='$campaignID'"
    );
