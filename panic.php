...
$insert = mysqli_query($con,"Insert into panic 
    (userid,teamarrivaltime,panictype,respondername,closuretime,closureauthority,randomt) 
    values 
    ('$userId',NOW() + INTERVAL 4 MINUTE,'robbery','Aslam',NOW() + INTERVAL 50 MINUTE,'police','$random')
    ");
